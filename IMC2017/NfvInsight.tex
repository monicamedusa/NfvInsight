...
\maketitle
\begin{abstract}
Network functioin virtualization (VFV) is promising to 
reduce cost for networking operators by replacing 
...
\begin{figure}[!t]
\centering
\subfloat[SFC1]{\includegraphics[width=3.3in]{throughput_chain1.pdf}
\label{throughput_SFC1}}
\hfil
\subfloat[SFC2]{\includegraphics[width=3.3in]{throughput_chain2.pdf}
