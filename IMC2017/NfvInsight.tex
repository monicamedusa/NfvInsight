...
receives feedback from authors of many SIGCOMM/NSDI papers.
...
network configuration and forwarding rule installation and so forth.
Besides, NfvInsight provides network traffic generators to drive NF-chains
