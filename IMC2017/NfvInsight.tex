...
users are supposed to run only one command to run the test, 
...
Figure \ref{design} shows the architecture of our benchmark. 
...
It does NF allocation, chaining automatically leveraging NFVI management framework.
Furthermore 
...
\label{cdf}
\centering
\includegraphics[width=3.3in]{cdf.pdf}
